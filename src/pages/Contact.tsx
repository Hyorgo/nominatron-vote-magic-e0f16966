...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="container max-w-2xl pt-32 pb-12 px-4 sm:px-6 relative z-[1]">
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3 golden-reflection">Contact</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="min-h-[150px] bg-white/5 border-white/10 focus:border-gold/50 transition-all duration-300 text-lg resize-none"
                  required
                />
              </div>
              <Button 
