...
export const ActionCard = ({ 
  ...
  return (
    <div className="bg-card/30 backdrop-blur-md backdrop-saturate-150 rounded-lg p-6 flex flex-col h-full border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:bg-card/40">
