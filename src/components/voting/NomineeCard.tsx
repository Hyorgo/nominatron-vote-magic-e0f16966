...
export const NomineeCard = ({ nominee, isSelected, onClick }: NomineeCardProps) => {
  ...
  // Gestion des images spécifiques pour MY, PLAN B, THE MAZE, F&K, L'ILE, BUS PARADISE, KAIA, NEL'S CLUB, LA MAISON BLEUE, LA FERIA et MADEMOISELLE SIMONE
          ...
          <div className="relative h-48 sm:h-64 overflow-hidden rounded-t-lg">
            <img
              ...
              className={cn(
                ...
                (isMyNominee || isPlanBNominee || isMazeNominee || isFKNominee || isIleNominee || isParadiseNominee || isKaiaNominee || isNelsClubNominee || isMaisonBleueNominee || isFeriaNominee || isSimoneNominee) && "bg-black p-4" // Ajout d'un fond noir et padding pour tous les logos
              )}
            />
            {isSelected && (
